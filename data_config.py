...
# seems discourse took a turning point here, around the $1000 peak
date_turning_point = dt.date(2013, 12, 8)

date_oos_begin = dt.date(2016, 3, 1)
date_is_end = date_oos_begin - dt.timedelta(days=1)
...
sentiment_sample_comment_prob = 1./4
sentiment_ewm_smoothing = 14

ug_svd_components = 32
lda_num_topics = 50
